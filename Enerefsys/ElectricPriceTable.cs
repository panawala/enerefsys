                ...
                try
                {
                    ...
                    foreach (DataRow dataRow in dt.Rows)
                    {
                        var standardLoad = new StandardLoad
                        {
                            ...
                            //DryTemperature = Math.Round(Convert.ToDouble(dataRow["DryTemperature"].ToString()),2),
                            //WetTemperature = Math.Round(Convert.ToDouble(dataRow["WetTemperature"].ToString()),2),
                            //Load = Math.Round(Convert.ToDouble(dataRow["Load"].ToString()),2),
